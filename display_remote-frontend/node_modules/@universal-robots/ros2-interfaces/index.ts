...
export enum IRosTypeRclInterfacesParameterType {
  PARAMETER_NOT_SET = 0,
  PARAMETER_BOOL = 1,
  PARAMETER_INTEGER = 2,
  PARAMETER_DOUBLE = 3,
...
export interface IRosTypeRclInterfacesGetLoggerLevels {
  request: IRosTypeRclInterfacesGetLoggerLevelsRequest;
  response: IRosTypeRclInterfacesGetLoggerLevelsResponse;
}

export interface IRosTypeRclInterfacesGetLoggerLevelsRequest {
  names: string[];
}

export interface IRosTypeRclInterfacesGetLoggerLevelsResponse {
  levels: IRosTypeRclInterfacesLoggerLevel[];
}
...
export interface IRosTypeRclInterfacesLoggerLevel {
  name: string;
  level: number;
}

export enum IRosTypeRclInterfacesLoggerLevelConst {
  LOG_LEVEL_UNKNOWN = 0,
  LOG_LEVEL_DEBUG = 10,
  LOG_LEVEL_INFO = 20,
  LOG_LEVEL_WARN = 30,
...
export interface IRosTypeRclInterfacesSetLoggerLevels {
  request: IRosTypeRclInterfacesSetLoggerLevelsRequest;
  response: IRosTypeRclInterfacesSetLoggerLevelsResponse;
}

export interface IRosTypeRclInterfacesSetLoggerLevelsRequest {
  levels: IRosTypeRclInterfacesLoggerLevel[];
}

export interface IRosTypeRclInterfacesSetLoggerLevelsResponse {
  results: IRosTypeRclInterfacesSetLoggerLevelsResult[];
}

export interface IRosTypeRclInterfacesSetLoggerLevelsResult {
  successful: boolean;
  reason: string;
}
...
export interface IRosTypeUrinterfacesUrErrorBase {
  line_number: number;
  column_number: number;
  description: IRosTypeStdMsgsString;
}
...
export interface IRosTypeUrinterfacesUrProgramCompilerResponse {
  has_error: boolean;
  error_message: IRosTypeUrinterfacesUrErrorBase;
}
