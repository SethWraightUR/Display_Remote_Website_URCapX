...
var ApiClient = /*#__PURE__*/function () {
   ...
   */
  function ApiClient() {
    var basePath = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'http://servicegateway/universal-robots/robot-api';
    _classCallCheck(this, ApiClient);
    /**
     * The base URL against which to resolve every API call's (relative) path.
     * @type {String}
     * @default http://servicegateway/universal-robots/robot-api
     */
  ...
  return _createClass(ApiClient, [{
    ...
    */
    ...
    function hostSettings() {
      return [{
        'url': "http://{host}/universal-robots/robot-api",
        'description': "No description provided",
        'variables': {
          host: {
            'description': "No description provided",
            'default_value': "servicegateway"
          }
        }
      }];
    }
