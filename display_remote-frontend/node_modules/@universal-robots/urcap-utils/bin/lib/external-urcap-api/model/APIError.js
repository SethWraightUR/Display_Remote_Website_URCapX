...
var APIError = /*#__PURE__*/function () {
   ...
   * General API error, used to return error details to API users.
  ...
  function APIError(message, details) {
    ...
    APIError.initialize(this, message, details);
  }
  ...
  return _createClass(APIError, null, [{
    key: "initialize",
    value: function initialize(obj, message, details) {
      obj['message'] = message;
      obj['details'] = details;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(APIError.RequiredProperties),
        _step;
      try {
...
APIError.RequiredProperties = ["message", "details"];
