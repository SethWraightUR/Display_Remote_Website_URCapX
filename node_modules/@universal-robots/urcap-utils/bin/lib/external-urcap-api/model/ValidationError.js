...
var _ValidationErrorLocInner = _interopRequireDefault(require("./ValidationErrorLocInner"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('loc')) {
          obj['loc'] = _ApiClient["default"].convertToType(data['loc'], [_ValidationErrorLocInner["default"]]);
        }
      ...
      if (data['loc']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ValidationErrorLocInner["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
